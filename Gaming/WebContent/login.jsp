...
<body class="login-layout light-login">
	<div class="main-container">
		<div class="main-content">
			<div class="row">
				<div class="col-sm-10 col-sm-offset-1">
					<div class="login-container">
						<div class="center">
							<h1 class="blue">
								<i class="ace-icon fa fa-desktop green"></i> GG gaming<br>
								เกมมิ่งเกียร์สำหรับคุณ<br>

							</h1>
							<h4 class="blue" id="id-company-text">&copy; จีจีเกมมิ่งจำกัดมหาชน</h4>
						</div>
											...
											<label class="block clearfix"> <span
												...
												<label class="block clearfix"> <span
															class="block input-icon input-icon-right"> <input
																...
																placeholder="Name - Surname" required="required"/> <i
																class="ace-icon fa fa-user-plus"></i>
														</span></label>
												<label class="block clearfix"> <span
													class="block input-icon input-icon-right"> <input
														type="text" name="IDCard" class="form-control"
														placeholder="Identification Number" required="required"/> <i
														class="ace-icon fa fa-id-card-o"></i>
												</span>
												</label> <label class="block clearfix"> <span
													class="block input-icon input-icon-right" >
														...
														placeholder="EMail" required="required"/> <i class="ace-icon fa fa-envelope"></i>
															...
															class="block input-icon input-icon-right"> <input
																...
																class="ace-icon fa fa-address-card"></i>
														</span></label><label class="block clearfix">

															<span class="block input-icon input-icon-right">
																	<input type="text" name="PhoneNO" class="form-control"
																	placeholder="Telphone" pattern="\d{3}\d{3}\d{4}" required="required"/> <i
			...
			<center class="bigger-125">
				PRINCIPLES OF SOFTWARE DESIGN AND DEVELOPMENT	322231<br>  Khon Kaen University Mittraphap Rd.,
	...
	<script type="text/javascript">
		window.jQuery
				|| document
						.write("<script src='bootstrap/js/jquery.js'>"
								+ "<"+"/script>");
	</script>
	...
	<script type="text/javascript">
		if ('ontouchstart' in document.documentElement)
			document
					.write("<script src='bootstrap/js/jquery.mobile.custom.js'>"
							+ "<"+"/script>");
	</script>
