	...
	<div id="wrapper">
		...
		<div class="sidebar-collapse">
			...
			<ul class="nav" id="side-menu">
					...
					<div class="user-section">
						...
						<div class="user-info">
							...
							<div class="user-text-online">
								<a class='btn-sm btn-danger' href='logout.php' width='50px'>Logout</a>
							</div>
						</div>
				...
				<li class="selected"><a href="insertadmin.php"><i
						class="fa fa-dashboard fa-fw"></i>รับจำนำสินค้า</a></li>
				<li class="selected"><a href="insertadmin2.php"><i
						class="fa fa-dashboard fa-fw"></i>เพิ่มADMIN</a></li>
				<li class="selected"><a href="tableadmin.php"><i
						class="fa fa-dashboard fa-fw"></i>ตาราง UPDATE/DELETE</a></li>
				<li class="selected"><a href="tableadmin2.php"><i
						class="fa fa-dashboard fa-fw"></i>ตารางUPDATE admins</a></li>
							...
							<div class="col-lg-4">
								...
								<div class="form-group">
									<label for="disabledTextInput">บัตรประชาชน 13 หลัก</label> <input
										...
										placeholder="1111111111111" name="CustomersID" required="required"
										pattern=".{13,13}">
								</div>
								...
								<div class="form-group">
									<label for="disabledTextInput">เลขรหัสสินค้า เช่น
										...
										placeholder="8850000111112" name="ProductID" required="required">
								</div>
								...
								<div class="form-group">
									<label for="disabledTextInput">รายละเอียดสินค้า</label> <input
										type="text" id="disabledTextInput" class="form-control"
										placeholder="Samsung J7" name="ProductDescription" required="required">
								</div>
